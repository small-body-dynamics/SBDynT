...
#    print(objname)
    try:       
        ...
        #fullfile=home+'/../../../hdd/haumea-data/djspenc/SBDynT_sims/'+filename+'/'+str(objname)+'/archive.bin'
        #fullfile='../data/results/'+objname+'/archive.bin'
        #fullfile='../data/results/1264_archive.bin'
        #print(fullfile)
        ...
        #print(objname)
        if archive[-1].t > 0:
            flag, a_init, e_init, inc_init, lan_init, aop_init, M_init, t_init = tools.read_sa_for_sbody(sbody = str(objname), archivefile=fullfile,clones=0,tmin=0.,tmax=archive[-1].t)
        else:
            flag, a_init, e_init, inc_init, lan_init, aop_init, M_init, t_init = tools.read_sa_for_sbody(des = str(objname), archivefile=fullfile,clones=0,tmax=0.,tmin=archive[-1].t)
        ...
        if small_planets_flag:
            ...
            if isinstance(av_init, int):
                if archive[-1].t > 0:
                    flag, av_init, ev_init, incv_init, lanv_init, aopv_init, Mv_init, t_init = tools.read_sa_for_sbody(des = str('venus'), archivefile=fullfile,clones=0,tmax=(archive[-1].t),tmin=0)
                    flag, ae_init, ee_init, ince_init, lane_init, aope_init, Me_init, t_init = tools.read_sa_for_sbody(des = str('earth'), archivefile=fullfile,clones=0,tmax=(archive[-1].t),tmin=0)
                    flag, am_init, em_init, incm_init, lanm_init, aopm_init, Mm_init, t_init = tools.read_sa_for_sbody(des = str('mars'), archivefile=fullfile,clones=0,tmax=(archive[-1].t),tmin=0)
                else:
                    flag, av_init, ev_init, incv_init, lanv_init, aopv_init, Mv_init, t_init = tools.read_sa_for_sbody(des = str('venus'), archivefile=fullfile,clones=0,tmin=(archive[-1].t),tmax=0)
                    flag, ae_init, ee_init, ince_init, lane_init, aope_init, Me_init, t_init = tools.read_sa_for_sbody(des = str('earth'), archivefile=fullfile,clones=0,tmin=(archive[-1].t),tmax=0)
                    flag, am_init, em_init, incm_init, lanm_init, aopm_init, Mm_init, t_init = tools.read_sa_for_sbody(des = str('mars'), archivefile=fullfile,clones=0,tmin=(archive[-1].t),tmax=0)
        ...
        if isinstance(aj_init, int):
            if archive[-1].t > 0 :
                flag, aj_init, ej_init, incj_init, lanj_init, aopj_init, Mj_init, t_init = tools.read_sa_for_sbody(des = str('jupiter'), archivefile=fullfile,clones=0,tmax=(archive[-1].t),tmin=0)
                flag, as_init, es_init, incs_init, lans_init, aops_init, Ms_init, t_init = tools.read_sa_for_sbody(des = str('saturn'), archivefile=fullfile,clones=0,tmax=(archive[-1].t),tmin=0)
                flag, au_init, eu_init, incu_init, lanu_init, aopu_init, Mu_init, t_init = tools.read_sa_for_sbody(des = str('uranus'), archivefile=fullfile,clones=0,tmax=(archive[-1].t),tmin=0)
                flag, an_init, en_init, incn_init, lann_init, aopn_init, Mn_init, t_init = tools.read_sa_for_sbody(des = str('neptune'), archivefile=fullfile,clones=0,tmax=(archive[-1].t),tmin=0)
            else:
                flag, aj_init, ej_init, incj_init, lanj_init, aopj_init, Mj_init, t_init = tools.read_sa_for_sbody(des = str('jupiter'), archivefile=fullfile,clones=0,tmin=(archive[-1].t),tmax=0)
                flag, as_init, es_init, incs_init, lans_init, aops_init, Ms_init, t_init = tools.read_sa_for_sbody(des = str('saturn'), archivefile=fullfile,clones=0,tmin=(archive[-1].t),tmax=0)
                flag, au_init, eu_init, incu_init, lanu_init, aopu_init, Mu_init, t_init = tools.read_sa_for_sbody(des = str('uranus'), archivefile=fullfile,clones=0,tmin=(archive[-1].t),tmax=0)
                flag, an_init, en_init, incn_init, lann_init, aopn_init, Mn_init, t_init = tools.read_sa_for_sbody(des = str('neptune'), archivefile=fullfile,clones=0,tmin=(archive[-1].t),tmax=0)
