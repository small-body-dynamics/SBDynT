...
..  toctree::
    ...
    TNO plotting script examples <notebooks/example-notebooks/TNO-Plotting-script-examples>
    synthetic proper elements default <notebooks/example-notebooks/synthetic-proper-elements-default>
    Setting up a basic small body integration <notebooks/example-notebooks/Setting-up-a-basic-small-body-integration>
    TNO classification with machine learning example <notebooks/example-notebooks/TNO-classification-with-machine-learning>
