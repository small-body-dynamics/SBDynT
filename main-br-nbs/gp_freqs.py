...
for i in range(len(astdys)):
    ...
    gp_freqs['h_j_amp'][i] = hjmax**2
    gp_freqs['k_j_amp'][i] = kjmax**2
    gp_freqs['p_j_amp'][i] = pjmax**2
    gp_freqs['q_j_amp'][i] = qjmax**2
    gp_freqs['h_s_amp'][i] = hsmax**2
    gp_freqs['k_s_amp'][i] = ksmax**2
    gp_freqs['p_s_amp'][i] = psmax**2
    gp_freqs['q_s_amp'][i] = qsmax**2
    gp_freqs['h_u_amp'][i] = humax**2
    gp_freqs['k_u_amp'][i] = kumax**2
    gp_freqs['p_u_amp'][i] = pumax**2
    gp_freqs['q_u_amp'][i] = qumax**2
    gp_freqs['h_n_amp'][i] = hnmax**2
    gp_freqs['k_n_amp'][i] = knmax**2
    gp_freqs['p_n_amp'][i] = pnmax**2
    gp_freqs['q_n_amp'][i] = qnmax**2
